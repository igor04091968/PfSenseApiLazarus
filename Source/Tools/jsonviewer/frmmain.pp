...
uses
  ...
  DefaultTranslator, SynEdit, SynHighlighterJScript,opensslsockets,openssl;
...
type
  ...
  TMainForm = class(TForm)
    ...
    procedure PCJSONChange(Sender: TObject);
    ...
    procedure TBJSONClick(Sender: TObject);
...
procedure TMainForm.PCJSONChange(Sender: TObject);
begin
...
procedure TMainForm.TBJSONClick(Sender: TObject);
begin
